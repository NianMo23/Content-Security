...
def main():
    ...
    parser.add_argument('--train_data', type=str, default="./r789-b-50000_train.xlsx")
    parser.add_argument('--val_data', type=str, default="./r789-b-50000_val.xlsx")
    parser.add_argument('--test_data', type=str, default="./r789-b-50000_test.xlsx")
    parser.add_argument('--output_dir', type=str, default="./lora_model_multi_gpu_contrastive/Qwen3-1.7B-202507070933")
