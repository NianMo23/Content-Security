...
def main():
    ...
    parser.add_argument('--checkpoint', type=str, required=False, default="/home/users/sx_zhuzz/folder/LLaMA-Factory/mymodels/Qwen3-1.7B",
                        help="原始模型的路径")
    parser.add_argument('--lora_model', type=str, required=False, default="./lora-mulgpu-1430/epoch-6",
                        help="保存的LoRA模型路径")
    ...
    results_file = os.path.join(output_dir, f'test_results_lora_{timestamp}.json')
